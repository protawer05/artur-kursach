...
db.serialize(() => {
	...
	db.run(`CREATE TABLE IF NOT EXISTS orders (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
				...
				date DATETIME DEFAULT (datetime('now')), -- ИСПОЛЬЗУЕМ datetime('now')
	...
	const stmt =
		db.prepare(`INSERT INTO products (name, price, category, thumbnail, description, ingredients, weight, volume, cookingTime)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`)
