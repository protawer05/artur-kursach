...
import { YMapsV3, YMapDefaultModules } from "../types";
...
export declare const initYamaps: ({ key, lang, coordorder, mode, apiKeys }: {
    key: string;
    lang: string;
    coordorder?: "latlong" | "longlat" | undefined;
    mode?: "release" | "debug" | undefined;
...
declare const YMapComponentsProvider: React.NamedExoticComponent<YMapComponentsProviderProps>;
...
export declare const getYmaps3ReadyObject: () => Promise<YMapsV3>;
